...
const Link = () => {
  return (
    <div className="mb-16 bg-sky-900 bg-grunge bg-blend-multiply bg-cover bg-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 place-items-center gap-5 md:gap-10">
          {links.map((link) => (
            <a href={link.url} target="_blank">
              <div className="w-full text-center p-4 bg-sky-800 border-slate-500 border flex flex-col justify-center gap-2 items-center">
