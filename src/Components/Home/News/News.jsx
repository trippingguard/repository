      ...
      <div className="mb-5 md:w-[980px] w-full mx-auto">
        ...
        <div className="flex flex-col gap-5">
          {newsContent.map((content) => (
            <div
              key={content.id}
              className="bg-gray-200 border border-gray-300 flex md:flex-row flex-col gap-4 items-center cursor-pointer"
            >
              <img src={content.url} className="h-auto w-full md:w-80" />
              <div className="pl-3 md:pl-0">
                <div className="text-sm text-sky-500 flex gap-4 my-1">
                  <div className="flex gap-1 items-center">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="fill-sky-500 size-3"
                    >
